...
<body>
    ...
    <div class="auth-container auth-container-dark">
        <div style="text-align: left; margin-bottom: 2rem;">
            <h1 style="margin-bottom: 0.5rem; font-size: 1.75rem; color: white;">Crear Cuenta</h1>
        ...
        <form action="<?php echo BASE_URL; ?>?controller=Auth&action=store" method="POST" style="text-align: left;">
        ...
        <div style="margin-top: 2rem; border-top: 1px solid var(--glass-border); padding-top: 1.5rem; font-size: 0.9rem; display: flex; justify-content: space-between; align-items: center;">
            <p style="color: var(--text-muted); margin: 0;">¿Ya tienes cuenta?</p>
            <a href="<?php echo BASE_URL; ?>?controller=Auth&action=login" style="color: var(--primary-light); font-weight: 600;">Inicia sesión</a>
        </div>
    </div>
